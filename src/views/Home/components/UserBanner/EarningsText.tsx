...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and TX8 pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and TX8 pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from TX8 pool', data)
  }
