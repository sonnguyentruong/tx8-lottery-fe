        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('You’ll spend TX8 to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your TX8 to buy the tokens being sold.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent TX8 tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
